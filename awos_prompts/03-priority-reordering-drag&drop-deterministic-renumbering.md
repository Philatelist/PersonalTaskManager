# AWOS Topic Prompt: Priority Reordering (Drag&Drop) + Deterministic Renumbering

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/04-priority-reordering-drag&drop-deterministic-renumbering.md`
- `/awos:tech  @awos_prompts/04-priority-reordering-drag&drop-deterministic-renumbering.md`
- `/awos:tasks @awos_prompts/04-priority-reordering-drag&drop-deterministic-renumbering.md`

## Topic
Priority Reordering (Drag&Drop) + Deterministic Renumbering

## Scope (what this topic covers)
User can reorder tasks via drag&drop; ranks renumber deterministically; cross-page moves; keyboard alternative optional; persistence of new order.

## Out of scope (for this topic)
Graph edges, AI, notes editor.
