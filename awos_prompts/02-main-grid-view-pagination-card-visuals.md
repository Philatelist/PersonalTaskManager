# AWOS Topic Prompt: Main Grid View + Pagination + Card Visuals

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/03-main-grid-view-pagination-card-visuals.md`
- `/awos:tech  @awos_prompts/03-main-grid-view-pagination-card-visuals.md`
- `/awos:tasks @awos_prompts/03-main-grid-view-pagination-card-visuals.md`

## Topic
Main Grid View + Pagination + Card Visuals

## Scope (what this topic covers)
Responsive square-card grid up to 100 per page; auto-resize; pagination; card content rules (priority number, deadline color, progress ring, 1-line title).

## Out of scope (for this topic)
Drag&drop reorder algorithm details (separate topic), graph view, AI chat.
