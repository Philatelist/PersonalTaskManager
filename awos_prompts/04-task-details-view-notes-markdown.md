# AWOS Topic Prompt: Task Details View + Notes (Markdown)

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/05-task-details-view-notes-markdown.md`
- `/awos:tech  @awos_prompts/05-task-details-view-notes-markdown.md`
- `/awos:tasks @awos_prompts/05-task-details-view-notes-markdown.md`

## Topic
Task Details View + Notes (Markdown)

## Scope (what this topic covers)
Open task details; show/edit attributes; show subtasks list; dependencies list; notes editor with markdown basics; without AI by default.

## Out of scope (for this topic)
AI chat UI and behavior (separate AI topic), advanced graph navigation.
