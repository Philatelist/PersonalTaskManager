# AWOS Topic Prompt: Deadlines + Visual Urgency + Overdue Indicator

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/07-deadlines-visual-urgency-overdue-indicator.md`
- `/awos:tech  @awos_prompts/07-deadlines-visual-urgency-overdue-indicator.md`
- `/awos:tasks @awos_prompts/07-deadlines-visual-urgency-overdue-indicator.md`

## Topic
Deadlines + Visual Urgency + Overdue Indicator

## Scope (what this topic covers)
Deadline field; step-based color ramp as deadline approaches; overdue indicator '+X days'; no reminders/triggers in v1; behavior for tasks without deadlines.

## Out of scope (for this topic)
Notifications/triggers, calendar integration.
