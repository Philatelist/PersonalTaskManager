# AWOS Topic Prompt: Core Task Model + Subtasks + Progress

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/01-core-task-model-subtasks-progress.md`
- `/awos:tech  @awos_prompts/01-core-task-model-subtasks-progress.md`
- `/awos:tasks @awos_prompts/01-core-task-model-subtasks-progress.md`

## Topic
Core Task Model + Subtasks + Progress

## Scope (what this topic covers)
Create/edit tasks with required fields; subtasks (text + taskRef); dynamic progress calculation; statuses (Active/Done/Deleted); tags; optional deadline; basic validation.

## Out of scope (for this topic)
Grid UI, dependency graph UI, AI chat, backups/conflicts deep details (covered elsewhere).
