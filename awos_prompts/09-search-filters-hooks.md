# AWOS Topic Prompt: Search + Filters Hooks

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/11-search-filters-hooks.md`
- `/awos:tech  @awos_prompts/11-search-filters-hooks.md`
- `/awos:tasks @awos_prompts/11-search-filters-hooks.md`

## Topic
Search + Filters Hooks

## Scope (what this topic covers)
Search tasks by title/tags; filter by status, deadline state, blocked; ensure extensible filter model for future; integrate with pagination.

## Out of scope (for this topic)
Advanced saved views; cloud sync.
