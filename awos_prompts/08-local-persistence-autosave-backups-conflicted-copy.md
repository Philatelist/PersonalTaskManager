# AWOS Topic Prompt: Local Persistence + Autosave + Backups + Conflicted Copy

This single file is intended to be used sequentially with AWOS standard commands:

- `/awos:spec  @awos_prompts/02-local-persistence-autosave-backups-conflicted-copy.md`
- `/awos:tech  @awos_prompts/02-local-persistence-autosave-backups-conflicted-copy.md`
- `/awos:tasks @awos_prompts/02-local-persistence-autosave-backups-conflicted-copy.md`

## Topic
Local Persistence + Autosave + Backups + Conflicted Copy

## Scope (what this topic covers)
Local storage layout for tasks and chats; autosave; atomic writes; daily backup rotation; corruption detection and recovery; conflicted copy handling and user notification.

## Out of scope (for this topic)
AI behavior, graph rendering specifics, UI styling details beyond what’s needed to test persistence.
